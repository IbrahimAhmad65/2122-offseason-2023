...
public class PinkarmSim {
    ...
    public PinkarmSim() {
        ...
        armRotationSim = new VariableLengthArmSim(DCMotor.getNEO(1), ArmConfig.motorRotationsPerArmRotation, j, ArmConfig.length1, -Math.PI, Math.PI / 2, ArmConfig.mass1 + ArmConfig.mass2, true);
